...
- **🎲 Ансамблевая вероятность осадков** — Smart берёт вероятность дождя из настоящего ансамбля ECMWF ENS (51 член, Open-Meteo Ensemble API, бесплатно): доля членов, видящих осадки, вместо «вероятности» детерминированных моделей. В модалке дня — полоса неопределённости «дождь в N% сценариев · сумма P10–P90 мм»
