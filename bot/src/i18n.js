...
const DICT = {
  ...
  'block.precip.nowThenDry': {
    ru: '🌦 Слабые осадки сейчас · далее без дождя',
    uk: '🌦 Слабкі опади зараз · далі без дощу',
    en: '🌦 Light precipitation now · dry later',
    de: '🌦 Leichter Niederschlag jetzt · später trocken',
    pl: '🌦 Słabe opady teraz · później bez deszczu',
    cs: '🌦 Slabé srážky nyní · později beze srážek',
    fr: '🌦 Faibles précipitations maintenant · sec ensuite',
    it: '🌦 Deboli precipitazioni ora · poi asciutto',
    es: '🌦 Precipitación débil ahora · luego seco'
  },
  'block.precip.snow': {
    ru: '❄ Снег: <b>{from}–{to}</b>',
    uk: '❄ Сніг: <b>{from}–{to}</b>',
...
const DICT_EXTRA = {
  ro: {
    ...
    'block.precip.nowThenDry': '🌦 Precipitații slabe acum · apoi uscat',
  ...
  hu: {
    ...
    'block.precip.nowThenDry': '🌦 Gyenge csapadék most · később száraz',
  ...
  sk: {
    ...
    'block.precip.nowThenDry': '🌦 Slabé zrážky teraz · neskôr bez dažďa',
  ...
  pt: {
    ...
    'block.precip.nowThenDry': '🌦 Precipitação fraca agora · depois seco',
  ...
  nl: {
    ...
    'block.precip.nowThenDry': '🌦 Lichte neerslag nu · later droog',
  ...
  tr: {
    ...
    'block.precip.nowThenDry': '🌦 Şu an hafif yağış · sonrası kuru',
  ...
  el: {
    ...
    'block.precip.nowThenDry': '🌦 Ασθενής υετός τώρα · έπειτα στεγνός',
