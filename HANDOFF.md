...
> **Текущая версия:** v1.57.0 (fix «дождь в посуточном списке / пусто в графике осадков»: на графике добавлена полупрозрачная полоса «возможных осадков» — макс. член ENS-ансамбля по часам, h.pmmPoss; ×16 языков)
