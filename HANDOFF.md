...
> **Текущая версия:** v1.62.2 (сводка бота согласована: заголовок из wc текущего часа, nowThenDry вместо ложного «не ожидается», завтра-лейбл даунгрейдится при пустой сумме; сайт-сводка не пишет «сухо» при активном nowcast; hero сворачивается плавно за 0.28s. v1.62.1 ниже)
