...
> **Текущая версия:** v1.56.0 (UI-апгрейд V1: дни вертикальным списком строк + почасовка в модалке дня вертикальным списком + плавающий нижний док-навигация; 3 этапа из PLAN_UI_UPGRADE.md)
