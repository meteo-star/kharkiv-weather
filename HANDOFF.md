...
> **Текущая версия:** v1.63.1 (график осадков говорит и процентами: ряд вероятностей по часам (те же h.p, что в модалке) + вероятность в тултипе. Жалоба 11.09 «график не соответствует часам»: данные совпадали, расходилась подача. v1.63.0 ниже: автокалибровка порога дождя)
