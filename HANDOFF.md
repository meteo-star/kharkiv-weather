...
> **Текущая версия:** v1.53.1 (человеческая формулировка ансамблевой строки — без «членов» и P10–P90)
...
| 4. Синхронизация бота + lead-корзины | бот считает те же per-variable веса из своего KV для push'ей (сейчас `source='smart'` в cron = невзвешенный mean, как avg); precip_soon/rain_soon — порог по доле членов ансамбля (перенесено из этапа 3 — обе правки в evaluateRule, делать вместе); predictions на D+1…D+5 с полем lead, статистика по корзинам D1–2 / D3–5 | ⬜ следующий |
