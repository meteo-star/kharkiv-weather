...
> **Текущая версия:** v1.62.0 (аудит Smart: полоса ансамбля «Сегодня» = остаток суток; PERF скролла: без глобального smooth, blur 24→14/9, строки дней без своего backdrop-filter, hero без layout-transition, пауза анимаций фона при прокрутке через html.is-scrolling. v1.61.0 ниже — Smart-вероятность из 8 моделей)
