...
> **Текущая версия:** v1.64.0 (лента облачности на графике осадков: canvas-плагин precipCloudBand, флаг отката PRECIP_CLOUD_BAND, чистое состояние до фичи: тег v1.63.1. v1.63.x ниже: проценты на графике, автокалибровка порога дождя)
