...
> **Текущая версия:** v1.62.1 (скролл: blur 10px десктоп / 9px моб., content-visibility нижних карточек, hover-freeze при прокрутке; свежесть: outlook.maybeFrom только для будущего часа, минутный тик NOW_HOUR → refreshForecast(false) при смене часа. v1.62.0 ниже — аудит Smart + основной перф скролла)
