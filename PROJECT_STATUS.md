...
> **Статус v1.29.0 (geo-refresh при reload):** ✅ закрыт — при `source === 'geo'` каждый старт переспрашивает координаты в фоне, источник погоды сохраняется
>
