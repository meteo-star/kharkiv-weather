...
> **Текущая версия:** v1.11-favorites-world
...
*Документ обновлён: 15 мая 2026 после релиза v1.11-favorites-world (фаза Ж — избранные города + 23 мировые столицы + улучшенный глобальный поиск через Geocoding API).*
*Следующий шаг: Аудио-резюме / Радар осадков / .ics-экспорт / Push-уведомления (требует backend) / Гипертермия алерты — выбор за пользователем.*
