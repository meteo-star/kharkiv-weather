...
> **Текущая версия:** v1.13-interactive-tiles
...
*Документ обновлён: 16 мая 2026 после релиза v1.13-interactive-tiles (фазы З-И: TTS-озвучка с выбором голоса, интерактивные плитки metrics, специальная модалка осадков с RainViewer-радаром и Windy-прогнозом 72ч).*
