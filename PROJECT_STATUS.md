...
>
> **Дата обновления:** 21 июня 2026
> **Текущая версия:** v1.58.0
...
> **Статус v1.57.0 (fix «дождь в списке / пусто в графике»: полоса «возможных осадков» в графике из членов ENS; ×16 языков):** ✅ закрыт
> **Статус v1.58.0 (согласование осадков по всем поверхностям: единый порог вероятности 30% + 3 состояния (дождь/шанс/сухо) в посуточном списке и модалке дня; фактически сухие дни 6%/0мм больше не метятся «дождём»; полоса графика — только при значимом шансе):** ✅ закрыт
