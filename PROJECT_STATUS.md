...
> **Текущая версия:** v1.10-inverse-search
...
*Документ обновлён: 15 мая 2026 после релиза v1.10-inverse-search (фаза Е — обратный поиск окон в прогнозе по описанию условия; 10 паттернов через regex + 6 пресетов из карточки "Окна возможностей").*
*Следующий шаг: Аудио-резюме / Multi-city favorites / Push-уведомления (требует backend) / Радар осадков / .ics-экспорт — выбор за пользователем.*
